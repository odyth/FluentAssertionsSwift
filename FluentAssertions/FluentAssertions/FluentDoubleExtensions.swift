...
{
    func shouldBeApproximately(_ expectedValue: Double, precision: Double, file: StaticString = #file, line: UInt = #line)
    {
    ...
    func shouldNotBeApproximately(_ unexpectedValue: Double, precision: Double, file: StaticString = #file, line: UInt = #line)
    {
