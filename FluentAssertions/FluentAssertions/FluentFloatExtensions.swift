...
{
    public func shouldBeApproximately(_ expectedValue: Float, precision: Float, file: StaticString = #file, line: UInt = #line)
    {
    ...
    public func shouldNotBeApproximately(_ unexpectedValue: Float, precision: Float, file: StaticString = #file, line: UInt = #line)
    {
